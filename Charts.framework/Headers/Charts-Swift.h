...
@property (nonatomic) BOOL drawGradientEnabled;
///
/// returns:
/// <code>true</code> if drawing gradient for this DataSet is enabled, <code>false</code> if not
@property (nonatomic, readonly) BOOL isDrawGradientEnabled;
